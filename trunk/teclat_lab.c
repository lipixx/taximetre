...
const char KeyCodeTable[16] = {'1','2','3','A','4','5','6','B','7','8','9','C','*','0','#','D'};

extern char keyScan()       // Scan for keyboard press
{
   ...
   while (!kbhit && (i<4))
   {
      switch(i)
      {
         case 0:  PORTB_0 = 0;  break;
         case 1:  PORTB_1 = 0;  break;
         case 2:  PORTB_2 = 0;  break;
         case 3:  PORTB_3 = 0;  break;
      }
      ...
      switch(i)
      {
         case 0:  PORTB_0 = 1;  break;
         case 1:  PORTB_1 = 1;  break;
         case 2:  PORTB_2 = 1;  break;
         case 3:  PORTB_3 = 1;  break;
      }
     if (temp != 0xF0)
      {
         col = i;
...
//		i=(i%4);
         ...
         if (temp == 0xF0) return(0x80);
		 else
		{
          switch(temp)
         {
            case 0b11100000:  temp = 0x00;   break;
            case 0b11010000:  temp = 0x01;   break;
            case 0b10110000:  temp = 0x02;   break;
            case 0b01110000:  temp = 0x03;   break;
         }
		}
